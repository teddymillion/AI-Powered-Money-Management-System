    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-foreground">AI Insights</span>
          <Badge variant="secondary" className="text-[10px] font-bold text-emerald-500 bg-emerald-500/10 border border-emerald-500/20">
            LIVE
          </Badge>
          {highlight && (
            <Badge variant="secondary" className="text-[10px] font-bold text-accent bg-accent/10 border border-accent/20">
              NEW
            </Badge>
          )}
        </div>
